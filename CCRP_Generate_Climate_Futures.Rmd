...
SiteID = "MACA"
site <- "MACA" # This is entered twice because the object is assigned differently in different scripts. The park code will only be entered once in future versions. 
state <- "Kentucky"
...
local_rss_dir <- 'C:/Users/msears/Documents/RSS/MACA/' # local directory where you want this repo copied. Should be something like 'C:/Users/adillon/Documents/RSS/CONG'
