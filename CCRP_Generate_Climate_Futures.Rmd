...
local_rss_dir <- 'C:/Users/adillon/Documents/RSS/GRCA-NE' # local directory where you want this repo copied. Should be something like 'C:/Users/adillon/Documents/RSS/CONG'

# -------------- Input site information -------------------------------------- #

SiteID = "GRCA-NE" # site = "GRCA-NE" - for testing
state <- "Arizona"
Lat = 36.27
Lon = -112.09
...
data.dir <- "C:/Users/adillon/Documents/RCF/NOAA-data/nClimGrid" # Location where NOAA ClimGrid data is stored, e.g. "E:/nClimGrid" 
...
```{r NOAA-parse, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r Water-Balance, message=FALSE, eval = FALSE, warning=FALSE, echo = FALSE, results=HIDE}
