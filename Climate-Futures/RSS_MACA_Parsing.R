...
OutDir = "C:/Users/achildress/Documents/RSS/Working/FIIS/MACA/"

#Variable and scenario names corresponding to MACA data directory structure
vars = c("pr", "tasmax", "tasmin","rhsmax","rhsmin") #for typical RSS, don't need rhsmin/rhsmax
scens = c("historical", "rcp45", "rcp85")

#Variable names for output tables
VarNames = c("PrecipCustom", "TmaxCustom", "TminCustom","RHmaxCustom","RHminCustom") #for typical RSS, don't need rhsmin/rhsmax
