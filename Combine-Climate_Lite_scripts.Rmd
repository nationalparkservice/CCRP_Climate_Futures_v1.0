...
-- unsure whether the following info is needed -- 
output:   
  html_document:
    df_print: paged
    fig_caption: yes
...
knitr::opts_chunk$set(
  ...
  fig.path = "./figures/" # AK NPS stores figures within parent directory of repo
)
...
```{r PRISM-plots, results=hide}

file <- list.files(path = './data', pattern = '.RData', full.names = TRUE) # will load all .RData files within directory
load(file)
