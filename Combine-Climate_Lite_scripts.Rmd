...
library(tmap); library(tmaptools); library(rJava); library(OpenStreetMap); library(gridExtra)
...
```{r Climate-Futures, echo=FALSE, fig.path='./figures/MACA', message=FALSE, warning=FALSE}
...
source(here::here("SummaryPlots/Summary plots.R"))

source(here::here("SummaryPlots/Summary WB plots.R")) 
```
