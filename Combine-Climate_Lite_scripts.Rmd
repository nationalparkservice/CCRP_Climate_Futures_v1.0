...
library(tmap); library(tmaptools); library(rJava); library(OpenStreetMap)
...
```{r Get-Params, message=FALSE, warning=FALSE, Get-Params fig.path='./figures/maps', results=HIDE}
