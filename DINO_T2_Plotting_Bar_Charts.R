...
setwd("C:/Users/adillon/Documents/Repos/CCRP-RSS-plots")

load("DINO-S_T1.RData")
...
#GCMs.sel<-as.factor(c("GFDL-ESM2G.rcp85","MIROC-ESM.rcp85", "CSIRO-Mk3-6-0.rcp45", "HadGEM2-ES365.rcp85")) # selected models for DINO 2020
...
FutureSubset <- c("Climate Future 1","Climate Future 2", "Climate Future 3", "Climate Future 4")          
Scenario1<-FutureSubset[1]
Scenario2<-FutureSubset[2]
Scenario3 <- FutureSubset[3]
Scenario4 <- FutureSeubset[4]
