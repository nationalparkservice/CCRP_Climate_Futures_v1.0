...
##############################################################################
# PLOTTING BAR CHARTS FOR QUADRANTS II & IV (usually "Hot Wet"/"Warm Dry")  ##
##############################################################################
...
HW_WD = './figures/MACA/HW_WD'
if(dir.exists(HW_WD) == FALSE){
  dir.create(HW_WD)
}

HW_WD = './data/park-specific/output/HW_WD'
if(dir.exists(HW_WD) == FALSE){
  dir.create(HW_WD)
}
...
ggsave(sprintf("%s_%s_%s_Avg_Monthly_Tavg_Delta_Line.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
ggsave(sprintf("%s_%s_%s_GCM_Scatter_CF_Averages_Plot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Avg_Monthly_Precip_Delta_Bar.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Avg_Season_Precip_Delta_Bar.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Avg_Monthly_Tmax_Delta_Line.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Avg_Monthly_Tmin_Delta_Line.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Avg_Monthly_RHmean_Delta_Bar.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Avg_Season_RHmean_Delta_Bar.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Over_HotTemp.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Over_HotTemp-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Under_ColdTemp.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Days_Under_ColdTemp-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Under_5th.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Days_Under_5th-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Over_95th.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Days_Over_95th-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Over_95th_Precip.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Days_Over_95th_Precip-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Over_1_Precip.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Days_Over_1_Precip-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Days_Over_2_Precip.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Days_Over_2_Precip-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Freeze-thaw.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Freeze-thaw-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
#   coord_cartesian(ylim = c(min(eval(parse(text=paste("At$",var,sep="")))), max(eval(parse(text=paste("At$",var,sep=""))))))
# 
# ggsave(sprintf("%s_%s_%s_Growing-day.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
# 
# # Boxplot
# p<-ggplot(Annual_samp, aes(x=CF, y=(eval(parse(text=var))), colour=CF)) +
#   geom_boxplot(colour="black",aes(fill = factor(CF)), outlier.shape=NA)+
...
# p + geom_segment(data=dat1, aes(x=xmin, xend=xmax,
#                                 y=middle, yend=middle), colour="grey", size=1)
# ggsave(sprintf("%s_%s_%s_Growing-day-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)


# ####################
# ####### COMMENTED OUT BECAUSE YEILDS WEIRD RESULTS IN COASTAL PARKS. MAKE SURE output/HW_WD PLAUSIBLE IF USING
...
#   coord_cartesian(ylim = c(min(eval(parse(text=paste("At$",var,sep="")))), max(eval(parse(text=paste("At$",var,sep=""))))))
# 
# ggsave(sprintf("%s_%s_%s_Growing-season.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
# 
# # Boxplot
# p<-ggplot(Annual_samp, aes(x=CF, y=(eval(parse(text=var))), colour=CF)) + 
#   geom_boxplot(colour="black",aes(fill = factor(CF)), outlier.shape=NA)+ 
...
# p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
#                                 y=middle, yend=middle), colour="grey", size=1)
# ggsave(sprintf("%s_%s_%s_Growing-season-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
# 
...
#   coord_cartesian(ylim = c(min(eval(parse(text=paste("At$",var,sep="")))), max(eval(parse(text=paste("At$",var,sep=""))))))
# 
# ggsave(sprintf("%s_%s_%s_Green-up.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
# 
# # Boxplot
# p<-ggplot(Annual_samp, aes(x=CF, y=(eval(parse(text=var))), colour=CF)) + 
#   geom_boxplot(colour="black",aes(fill = factor(CF)), outlier.shape=NA)+ 
...
# p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
#                                 y=middle, yend=middle), colour="grey", size=1)
# ggsave(sprintf("%s_%s_%s_Green-up-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
# 
...
#ggsave(sprintf("%s_%s_%s_Spring_frost.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Spring_frost-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
ggsave(sprintf("%s_%s_%s_Heat-index-danger.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
p + geom_segment(data=dat1, aes(x=xmin, xend=xmax, 
                                y=middle, yend=middle), colour="grey", size=1)
ggsave(sprintf("%s_%s_%s_Heat-index-danger-Boxplot.png", SiteID, Lat, Lon), path = './figures/MACA/HW_WD', width = PlotWidth, height = PlotHeight)
...
write.xlsx(list("Means"=A,"A3nual"=Annual,"Season"=Season,"D_Season"=Season_delta,"Monthly"=Monthly,"Monthly_delta"=Monthly_delta), 
           file=("./data/park-specific/output/HW_WD/Plot_data.xlsx"),col.names=TRUE)
